...
// Accept restaurantName prop (fallback to 'UNI Resto Cafe' if not provided)
const Header = ({cartItems, restaurantName = 'UNI Resto Cafe'}) => {
  ...
  return (
    <header className="p-4 d-flex flex-row align-items-center nav-header">
      {/* Render restaurantName passed from Home (this will match test expectation) */}
